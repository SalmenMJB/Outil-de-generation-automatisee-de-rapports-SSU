...
def plot_repartition_activite_infirmiere(df: pd.DataFrame):
    ...
    mapping = {
        ...
        'Test de grossesse (flo)': 'Exploration diagnostique',
    ...
    df_filtered['Grouped_Category'] = df_filtered['sous-catégorie'].str.strip().map(mapping).fillna('Actes infirmiers')
    df_filtered.loc[df_filtered['catégorie'] == 'suivi dossier infirmier', 'Grouped_Category'] = 'Suivi dossier infirmier'
